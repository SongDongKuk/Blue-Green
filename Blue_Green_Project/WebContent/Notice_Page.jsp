...
<div class="ui large top fixed hidden menu">
  <div class="ui container">
    <a href="Main_Page.jsp" class="item">Home</a>
    <a href="Notice_Page.jsp" class="active item">공지사항</a>
    <a class="item">교육신청</a>
    <a class="item">경기안내</a>
    <a class="item">커뮤니티</a>
    <a class="item">도움말</a>
    ...
    <div class="column" >
      ...
      <div class="ui two column grid">      
        <div class="sixteen wide column">
          <table bgcolor="white" class="ui celled structured table" id="notice">
            <thead>
              <tr >
                <th style="background-color: gray;">번호</th>
	      ...
	      <div class="ui stackable inverted divided equal height stackable grid">
	        ...
	        <div class="three wide column">
	          ...
	          <div class="ui inverted link list">
	            ...
	            <a href="#" class="item">이용방법</a>
	          </div>
	        </div>
	        <div class="seven wide column">
	          <h4 class="ui inverted header">Footer Header</h4>
	          <p>Copyright (C) Time is Running Out All rights reserved.<br>
				Last Update : 2018/01/05<br>
				본 홈페이지는 1080*1024 해상도에 최적화 되어있습니다.<br>
				본 홈페이지는 Chrome에서 가장 잘 표현됩니다.</p>
			</div>
	      </div>
	    </div>
	  </div>
